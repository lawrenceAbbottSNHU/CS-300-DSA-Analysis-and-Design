...
One place where it would be nice to improve this code would be to include the ability for the user to select the appropriate file from which to load the courses, via a file system interface, thus reducing the propability that the user mistakenly mistypes the file name. 
